        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 items-center self-start md:gap-8">
          <div>
            <div className="max-w-lg md:max-w-none self-start  px-3 md:px-0">
              ...
              <p className='py-4 lg:w-[550px]'>Medicare Por helps hospitals perform their daily operations quickly, accurately, and efficiently with the help of advanced technology.</p>
              <Link href="/doctor">
